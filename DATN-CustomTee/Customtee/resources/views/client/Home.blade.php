                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a  href="{{ url('/ShopSingle') }}" class="h2 text-decoration-none text-dark">Gym Weight</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a  href="{{ url('/ShopSingle') }}" class="h2 text-decoration-none text-dark">Cloud Nike Shoes</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a  href="{{ url('/ShopSingle') }}" class="h2 text-decoration-none text-dark">Summer Addides Shoes</a>
                            <p class="card-text">
